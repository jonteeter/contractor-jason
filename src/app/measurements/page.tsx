    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
              ...
              <h1 className="text-lg sm:text-xl font-bold text-slate-900 truncate">Project Measurements</h1>
            </div>
            ...
            <div className="flex items-center justify-between gap-2 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-4 text-xs sm:text-sm min-w-0 flex-1">
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <Calculator className="w-3 h-3 sm:w-4 sm:h-4 text-amber-600 flex-shrink-0" />
                  <span className="font-medium text-slate-700 truncate">
                    Total: {measurements.totalSqft.toFixed(1)} sq ft
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                ...
                <span className="text-sm sm:text-lg font-bold text-amber-700 whitespace-nowrap">
                  ${measurements.estimatedCost.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
                </span>
              </div>
            </div>
          </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-12 safe-area-bottom">
        ...
        <div className="flex justify-between items-center mt-8 sm:mt-16 max-w-4xl mx-auto gap-3 sm:gap-4">
          ...
          >
            <span className="hidden sm:inline">{saving ? 'Saving...' : step === totalSteps ? 'Generate Estimate' : 'Next'}</span>
